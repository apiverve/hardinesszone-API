...
async function callUSDAHardinessZoneAPI() {
    try {
        ...
        const response = await fetch(`https://api.apiverve.com/v1/hardinesszone?${params}`, {
            method: 'GET',
            headers: {
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/hardinesszone](https://docs.apiverve.com/ref/hardinesszone)

---

## Use Cases

Common use cases for the USDA Hardiness Zone API:
